...
//		gameStatus = GameState.READY;
	...
	public void initialiseGameWorld() {
		...
		staticObjects.add(new Obstacle(worldBox2D, 100, 50, 
				10 * GameObject.PIXELS_TO_METERS, 10 * GameObject.PIXELS_TO_METERS, 0));
		staticObjects.add(new Obstacle(worldBox2D, 120, 50, 
				10 * GameObject.PIXELS_TO_METERS, 10 * GameObject.PIXELS_TO_METERS, 0));
		staticObjects.add(new Obstacle(worldBox2D, 140, 50, 
				10 * GameObject.PIXELS_TO_METERS, 10 * GameObject.PIXELS_TO_METERS, 0));
		staticObjects.add(new PowerUp(worldBox2D, 200, 50, 
				100 * GameObject.PIXELS_TO_METERS, 100 * GameObject.PIXELS_TO_METERS, 0));
	}
